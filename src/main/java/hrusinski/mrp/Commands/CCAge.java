        ...
        if(sender instanceof Player){
            ...
            if(args.length == 1){
                if(config.getString("region").equals("EN")){
                    ...
                    player.sendMessage(ChatColor.translateAlternateColorCodes('&', configEN.getString("Messages.Command.CC.Age")));
                } else {
                    ...
                    configCC.set("Info.Age", args[0].toString());
                    player.sendMessage(ChatColor.translateAlternateColorCodes('&', configCZ.getString("Messages.Command.CC.Age")));
                }
                try {
