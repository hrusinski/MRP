        ...
        if(sender instanceof Player){
            ...
            if(sender.getServer().getPlayer(args[0]) instanceof Player){
                ...
                if(config.getString("region").equals("EN")){
                    ...
                    configCC.set("Info.Name", "Steve");
                    configCC.set("Info.Surname", "Mine");
                    configCC.set("Info.Age", "21");
                    configCC.set("Info.Gender", "Male");
                    configCC.set("Info.Nationality", "MineNation");
