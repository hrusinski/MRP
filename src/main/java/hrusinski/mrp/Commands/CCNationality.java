...
public class CCNationality implements CommandExecutor {
        ...
        if(sender instanceof Player){
            ...
            if(args.length == 1){
                if(config.getString("region").equals("EN")){
                    ...
                    configCC.set("Info.Nationality", args[0].toString());
                    player.sendMessage(ChatColor.translateAlternateColorCodes('&', configEN.getString("Messages.Command.CC.Nationality")));
                } else {
                    ...
                    configCC.set("Info.Nationality", args[0].toString());
                    player.sendMessage(ChatColor.translateAlternateColorCodes('&', configCZ.getString("Messages.Command.CC.Nationality")));
                }
                try {
